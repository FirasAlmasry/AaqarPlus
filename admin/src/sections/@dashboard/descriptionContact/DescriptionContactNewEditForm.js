...
DescriptionContactNewEditForm.propTypes = {
    isEdit: PropTypes.bool,
    currentService: PropTypes.object,
};

export default function DescriptionContactNewEditForm({ isEdit = false, currentService }) {
    const navigate = useNavigate();

    const { enqueueSnackbar } = useSnackbar();

    const NewDescriptionContactSchema = Yup.object().shape({
        title: Yup.object({
    ...
    const methods = useForm({
        resolver: yupResolver(NewDescriptionContactSchema),
        defaultValues,
    });
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            navigate(PATH_DASHBOARD.descriptionContact.list);
                ...
                <Grid item xs={12} md={8}>
                    <Card sx={{ p: 3 }}>
                        ...
                        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
                            ...
                            >
                                {!isEdit ? "Create DescriptionContact" : "Save Changes"}
                            </LoadingButton>
                        </Stack>
                    </Card>
                </Grid>
