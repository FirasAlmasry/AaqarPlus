...
SliderImageNewEditForm.propTypes = {
    isEdit: PropTypes.bool,
    currentService: PropTypes.object,
};

export default function SliderImageNewEditForm({ isEdit = false, currentService }) {
    const navigate = useNavigate();

    const { enqueueSnackbar } = useSnackbar();

    const NewSliderImageSchema = Yup.object().shape({
        title: Yup.object({
    ...
    const methods = useForm({
        resolver: yupResolver(NewSliderImageSchema),
        defaultValues,
    });
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            navigate(PATH_DASHBOARD.sliderImage.list);
                ...
                <Grid item xs={12} md={8}>
                    <Card sx={{ p: 3 }}>
                        ...
                        <Stack alignItems="flex-end" sx={{ mt: 3 }}>
                            ...
                            >
                                {!isEdit ? "Create SliderImage" : "Save Changes"}
                            </LoadingButton>
                        </Stack>
                    </Card>
                </Grid>
