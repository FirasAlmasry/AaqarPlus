...
// sections
import {
    SliderImageTableToolbar,
    SliderImageTableRow,
} from "../../../sections/@dashboard/sliderImage/list";
...
export default function SliderImageListPage() {
    const {
        dense,
        page,
        order,
    ...
    const handleEditRow = (id) => {
        navigate(PATH_DASHBOARD.sliderImage.edit(paramCase(id)));
    };
    ...
    return (
        <>
            <Helmet>
                <title> SliderImage: List </title>
            </Helmet>

            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    heading="SliderImage List"
                    links={[
                    ...
                    action={
                        <Button
                            ...
                            to={PATH_DASHBOARD.sliderImage.new}
                            variant="contained"
