...
export default function SliderImageEditPage() {
    ...
    return (
        <>
            <Helmet>
                <title> SliderImage: Edit SliderImage</title>
            </Helmet>

            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    heading="Edit SliderImage"
                    links={[
                        {
                            name: "Dashboard",
                ...
                {isServiseLoading ? "loading" :
                    <SliderImageNewEditForm isEdit currentService={data?.servise} />
                }
            </Container>
        </>
    );
