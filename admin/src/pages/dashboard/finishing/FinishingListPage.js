...
// sections
import {
    FinishingTableToolbar,
    FinishingTableRow,
} from "../../../sections/@dashboard/finishing/list";
import { useDeleteFinishingMutation, useGetFinishingQuery } from "../../../state/finishing";
...
export default function FinishingListPage() {
    ...
    const { data, isLoading, refetch } = useGetFinishingQuery();
    ...
    const [deleteFinishing] = useDeleteFinishingMutation()
    ...
    const handleEditRow = (id) => {
        id = String(id);
        navigate(PATH_DASHBOARD.finishing.edit(paramCase(id)));
    };
    ...
    return (
        <>
            <Helmet>
                <title> Finishing: List</title>
            </Helmet>

            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    heading="Finishing List"
                    links={[
                        { name: "Dashboard", href: PATH_DASHBOARD.root },
                        {
                            name: "Finishing",
                            href: PATH_DASHBOARD.finishing.root,
                        },
                        { name: "List" },
                    ]}
                    action={
                        <Button
                            ...
                            to={PATH_DASHBOARD.finishing.new}
                            variant="contained"
