...
// sections
import {
    DescriptionContactTableToolbar,
    DescriptionContactTableRow,
} from "../../../sections/@dashboard/descriptionContact/list";
...
export default function DescriptionContactListPage() {
    const {
        dense,
        page,
        order,
    ...
    const handleEditRow = (id) => {
        navigate(PATH_DASHBOARD.descriptionContact.edit(paramCase(id)));
    };
    ...
    return (
        <>
            <Helmet>
                <title> DescriptionContact: List </title>
            </Helmet>

            <Container maxWidth={themeStretch ? false : "lg"}>
                <CustomBreadcrumbs
                    heading="DescriptionContact List"
                    links={[
                    ...
                    //         to={PATH_DASHBOARD.DescriptionContact.new}
                    //         variant="contained"
                    //         startIcon={<Iconify icon="eva:plus-fill" />}
                    //     >
                    //         New DescriptionContact
                    //     </Button>
                    // }
                />
