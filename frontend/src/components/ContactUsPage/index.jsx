                            ...
                            <GlobalList>
                                ...
                                <Grid item xs={12} >
                                    <Box sx={{ display: 'flex', flexDirection:{md:'row', xs:'row'}, gap: { md: 4 ,xs:1}, ml: { md: 4,xs:0 }}} >
                                        <CardMedia loading='lazy' src={user} alt='image' component={'img'} sx={{ width: {md:'7%',xs:'15%'}, m:0, objectFit:'contain' }} />
                                        <Box>
                                ...
                                <Grid item xs={12} >
                                    <Box sx={{ display: 'flex', flexDirection:{md:'row', xs:'row'}, gap: { md: 4, xs: 1 }, ml: { md: 4, xs: 0 } }} >
                                        <CardMedia loading='lazy' src={location} alt='image' component={'img'} sx={{ width: {md:'7%',xs:'15%'}, m:0, objectFit:'contain' }} />
                                        <Box>
