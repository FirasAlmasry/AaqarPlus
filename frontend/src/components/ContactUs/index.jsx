...
const ContactUs = () => {
    ...
    return (
        <>
            <Box position={'relative'} sx={{ backgroundImage: `url(${img})`, height: { md: '40rem' ,xs:'45rem'}, display: 'flex', alignItems: 'center', backgroundSize: '100% 100%',  position: 'relative', backgroundAttachment: 'fixed' }} > 
                <div className="overlay">
                    ...
                    <Box sx={{ py:1 ,px: 2, background: '#fff', borderRadius: '16px',my:2 ,mx: { md: 2, xs: 0 }, width: {md:'45%', xs:'100%'}, }}>
                        <Form />
                    </Box>
                </div>
            </Box>
